function MATS = MatAssem2D_MS4()
    ...
    I34 = Integral(Omega,L4.val*dt.val*(4*q_bar.grad(1,2)*uu.grad(1,1) + 4*q_bar.grad(1,1)*uu.grad(1,2))*vv.val(1));
    I35 = Integral(Omega,L4.val*dt.val*(2*q_bar.grad(2,2)*uu.grad(1,1) + 2*q_bar.grad(2,1)*uu.grad(1,2))*vv.val(2));
    I36 = Integral(Omega,L4.val*dt.val*(2*q_bar.grad(1,1)*uu.grad(2,2) + 2*q_bar.grad(1,2)*uu.grad(2,1))*vv.val(2));
    I37 = Integral(Omega,L4.val*dt.val*(2*q_bar.grad(3,2)*uu.grad(1,1) + 2*q_bar.grad(3,1)*uu.grad(1,2))*vv.val(3));
    I38 = Integral(Omega,L4.val*dt.val*(2*q_bar.grad(1,1)*uu.grad(3,2) + 2*q_bar.grad(1,2)*uu.grad(3,1))*vv.val(3));
    Mass_Matrix2 = Mass_Matrix2 + I1 + I2 + I3 + I4 + I5 + I6 + I7 + I8 + I9 + I20 + I34 + I35 + I36 + I37 + I38;
    ...
    I39 = Integral(Omega,L4.val*dt.val*(4*q_bar.val(1)*uu.grad(1,2)*vv.grad(1,1) + 4*q_bar.grad(1,2)*uu.val(1)*vv.grad(1,1) + 4*q_bar.grad(1,1)*uu.val(1)*vv.grad(1,2) + 4*q_bar.val(1)*uu.grad(1,1)*vv.grad(1,2)));
    I40 = Integral(Omega,L4.val*dt.val*(2*q_bar.val(2)*uu.grad(2,1)*vv.grad(1,2) + 2*q_bar.grad(2,1)*uu.val(2)*vv.grad(1,2) + 2*q_bar.val(2)*uu.grad(2,2)*vv.grad(1,1) + 2*q_bar.grad(2,2)*uu.val(2)*vv.grad(1,1)));
    I41 = Integral(Omega,L4.val*dt.val*(2*q_bar.val(3)*uu.grad(3,2)*vv.grad(1,1) + 2*q_bar.grad(3,2)*uu.val(3)*vv.grad(1,1) + 2*q_bar.val(3)*uu.grad(3,1)*vv.grad(1,2) + 2*q_bar.grad(3,1)*uu.val(3)*vv.grad(1,2)));
    I42 = Integral(Omega,L4.val*dt.val*(2*q_bar.val(2)*uu.grad(1,1)*vv.grad(2,2) + 2*q_bar.val(2)*uu.grad(1,2)*vv.grad(2,1)));
    I43 = Integral(Omega,L4.val*dt.val*(2*q_bar.grad(1,1)*uu.val(2)*vv.grad(2,2) + 2*q_bar.grad(1,2)*uu.val(2)*vv.grad(2,1)));
    I44 = Integral(Omega,L4.val*dt.val*(2*q_bar.val(3)*uu.grad(1,2)*vv.grad(3,1) + 2*q_bar.val(3)*uu.grad(1,1)*vv.grad(3,2)));
    I45 = Integral(Omega,L4.val*dt.val*(2*q_bar.grad(1,2)*uu.val(3)*vv.grad(3,1) + 2*q_bar.grad(1,1)*uu.val(3)*vv.grad(3,2)));
    Stiff_Matrix2 = Stiff_Matrix2 + I21 + I22 + I23 + I24 + I25 + I26 + I39 + I40 + I41 + I42 + I43 + I44 + I45;
    ...
    I46 = Integral(Omega,L4.val*dt.val*((2/sqrt(3))*(q_n.grad(1,2)*q_bar.grad(1,2)*vv.val(1) - 2*q_n.grad(1,1)*q_bar.grad(1,1)*vv.val(1) - 2*q_bar.val(1)*q_n.grad(1,1)*vv.grad(1,1) + q_bar.val(1)*q_n.grad(1,2)*vv.grad(1,2)) - 2*q_n.grad(2,2)*q_bar.grad(1,2)*vv.val(1) - 4*q_bar.grad(1,2)*q_bar.grad(1,1)*vv.val(1) - 4*q_bar.val(1)*q_bar.grad(1,2)*vv.grad(1,1) - 2*q_bar.val(2)*q_bar.grad(2,2)*vv.grad(1,1) - 2*q_bar.val(3)*q_bar.grad(3,2)*vv.grad(1,1) - 2*q_bar.val(1)*q_n.grad(2,2)*vv.grad(1,2) - 4*q_bar.val(1)*q_bar.grad(1,1)*vv.grad(1,2) - 2*q_bar.val(2)*q_bar.grad(2,1)*vv.grad(1,2) - 2*q_bar.val(3)*q_bar.grad(3,1)*vv.grad(1,2)));
    I47 = Integral(Omega,L4.val*dt.val*((2/sqrt(3))*(q_n.grad(1,2)*q_bar.grad(2,2)*vv.val(2) - 2*q_n.grad(1,1)*q_bar.grad(2,1)*vv.val(2) - 2*q_bar.val(2)*q_n.grad(1,1)*vv.grad(2,1) + q_bar.val(2)*q_n.grad(1,2)*vv.grad(2,2)) - 2*q_n.grad(2,2)*q_bar.grad(2,2)*vv.val(2) - 2*q_bar.grad(2,2)*q_bar.grad(1,1)*vv.val(2) - 2*q_bar.grad(1,2)*q_bar.grad(2,1)*vv.val(2) - 2*q_bar.val(2)*q_bar.grad(1,2)*vv.grad(2,1) - 2*q_bar.val(2)*q_n.grad(2,2)*vv.grad(2,2) - 2*q_bar.val(2)*q_bar.grad(1,1)*vv.grad(2,2)));
    I48 = Integral(Omega,L4.val*dt.val*((2/sqrt(3))*(q_n.grad(1,2)*q_bar.grad(3,2)*vv.val(3) - 2*q_n.grad(1,1)*q_bar.grad(3,1)*vv.val(3) - 2*q_bar.val(3)*q_n.grad(1,1)*vv.grad(3,1) + 2*q_bar.val(3)*q_n.grad(1,2)*vv.grad(3,2)) - 2*q_n.grad(2,2)*q_bar.grad(3,2)*vv.val(3) - 2*q_bar.grad(1,1)*q_bar.grad(3,2)*vv.val(3) - 2*q_bar.grad(1,2)*q_bar.grad(3,1)*vv.val(3) - 2*q_bar.val(3)*q_bar.grad(1,2)*vv.grad(3,1) - 2*q_bar.val(3)*q_n.grad(2,2)*vv.grad(3,2) - 2*q_bar.val(3)*q_bar.grad(3,1)*vv.grad(3,2)));
    RHS2 = RHS2 + I10 + I11 + I12 + I13 + I14 + I15 + I16 + I17 + I18 + I19 + I27 + I28 + I29 + I30 + I31 + I32 + I33 + I46 + I47 + I48;
