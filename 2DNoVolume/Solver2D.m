function [S,Q,F_F] = Solver2D(q_0,Mesh,DoFMap,LEB,alph,L,L2,L3,dt,tol,numits,H,Dirichlet,AG)
    ...
    E = MS2DEnergy([],Mesh.Points,DoFMap,[],[],DoFMap,DoFMap,DoFMap,H,L,L2,L3,Lam,Z,alph,q_0);
    F0 = E(1).MAT;
    F_F(1) = F0;
    FEM1 = [];
    FEM2 = [];
    ...
    for its = 1:numits
        ...
        %Get Mats
        FEM1 = MS2DAssemble1(FEM1,Mesh.Points,DoFMap,[],[],DoFMap,DoFMap,DoFMap,H,L,L2,L3,alph,dt,q_0);
        LHSMass1 = FEM1(1).MAT;
        ...
        for newtits = 1:50 %usually converges in much less
            ...
            Lam = Lam(:,1:2);
            %Get Mats
            FEM2 = MS2DAssemble2(FEM2,Mesh.Points,DoFMap,[],[],DoFMap,DoFMap,DoFMap,L,L2,L3,Lam,dLam,dt,q_bar_1,q_0);
            LHSMass2 = FEM2(1).MAT;
            RHS2 = FEM2(2).MAT;
        ...
        %Get Mats
        FEM3 = MS2DAssemble3(FEM3,Mesh.Points,DoFMap,[],[],DoFMap,DoFMap,H,L,L2,L3,alph,dt,q_0);
        LHSMass1 = FEM3(1).MAT;
        ...
        for newtits = 1:50
            ...
            %Get Mats
            FEM4 = MS2DAssemble4(FEM4,Mesh.Points,DoFMap,[],[],DoFMap,DoFMap,DoFMap,L,L2,L3,Lam,dLam,dt,q_bar_2,q_0);
            LHSMass2 = FEM4(1).MAT;
            RHS2 = FEM4(2).MAT;
